...
public class Label_jugador extends Entidad_grafica {
	...
	public void setPowerUpVelocidad() {
		super.reDimensionar(this,
				new ImageIcon(getClass().getResource("/RecursosGraficos_Jugador/uy-kieto velocidad.png")));
	}

	public void setPowerUpSuperArma() {
		super.reDimensionar(this,
				new ImageIcon(getClass().getResource("/RecursosGraficos_Jugador/uy-kieto superArma.png")));
	}
	...
	public void setPowerUpInmunidad() {
		super.reDimensionar(this,
				new ImageIcon(getClass().getResource("/RecursosGraficos_Jugador/uy-kieto inmunidad.png")));
	}
}
